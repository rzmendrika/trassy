		...
		<div class="row mt-5 align-items-center no-gutters">
			<div class="col-12 col-sm-10 col-md-6 m-auto col-lg-3 text-center shadow">
				<div class="bg-white pb-5 pt-5 pl-4 pr-4 rounded-left">
					...
					<p class="text-center pt-4"><a href="{{ route('client.payment.create', [config('global.restau.id'), 1]) }}" class="btn btn-outline-dark">Choisir</a></p>
				</div>
			</div>
			...
			<div class="col-12 col-sm-10 col-md-6 ml-auto mr-auto col-lg-3 text-center mt-4 mt-lg-0 sl-1 pt-0 pt-lg-3 pb-0 pb-lg-3 bg-white fdb-touch rounded shadow">
				<div class="pb-5 pt-5 pl-4 pr-4">
					...
					<p class="text-center pt-4"><a href="{{ route('client.payment.create', [config('global.restau.id'), 2]) }}" class="btn btn-primary btn-shadow">Choisir</a></p>
				</div>
			</div>
			...
			<div class="col-12 col-sm-10 col-md-6 ml-auto mr-auto col-lg-3 text-center mt-4 mt-lg-0 sl-1 pt-0 pt-lg-3 pb-0 pb-lg-3 bg-white fdb-touch rounded shadow">
				<div class="bg-white pb-5 pt-5 pl-4 pr-4 rounded-right">
					...
					<p class="text-center pt-4"><a href="{{ route('client.payment.create', [config('global.restau.id'), 3]) }}" class="btn btn-outline-dark">Choisir</a></p>
				</div>
			</div>
			...
			<div class="col-12 col-sm-10 col-md-6 ml-auto mr-auto col-lg-3 text-center mt-4 mt-lg-0 shadow">
				<div class="bg-white pb-5 pt-5 pl-4 pr-4 rounded-right">
					...
					<p class="text-center pt-4"><a href="{{ route('client.payment.create', [config('global.restau.id'), 4]) }}" class="btn btn-outline-dark">Choisir</a></p>
				</div>
			</div>
		</div>
	</div>
